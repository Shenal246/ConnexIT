...
const Latest = () => {
    ...
    const fetchNews = async () => {
        // Latest One
        const values = {
            query: "SELECT title,link,type,status,image_data,cnt FROM news WHERE type=3 AND status=1 AND cnt=5;",
            key: "Cr6re8VRBm"
        };
        ...
        // Latest Two
        const value2 = {
            query: "SELECT title,link,type,status,image_data,cnt FROM news WHERE type=4 AND status=1 AND cnt=5;",
            key: "Cr6re8VRBm"
        };
        ...
        // Latest Three
        const value3 = {
            query: "SELECT title,link,type,status,image_data,cnt FROM news WHERE type=5 AND status=1 AND cnt=5;",
            key: "Cr6re8VRBm"
        };
        ...
        // Latest Four
        const value4 = {
            query: "SELECT title,link,type,status,image_data,cnt FROM news WHERE type=6 AND status=1 AND cnt=5;",
            key: "Cr6re8VRBm"
        };
    ...
    const { Murilattopic } = t('Murilatestsec', { returnObjects: true });
        ...
        <section >
            <div className='container latest'>
                <div className="row gy-3 headingRow" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="50">
                    ...
                    <div className="col-4"><p id='whoweareText'>{Murilattopic}</p></div>
                    <div className="col-4"><hr /></div>
                </div>
                ...
                <div className="row backgrnd" >
                    ...
                    <div className="row" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="50">
                        <div className="navigation">
                            <NavLink to="/MU/Events&News"><Button variant="" className='iconsss' style={{ backgroundColor: '#01066B' }}>
