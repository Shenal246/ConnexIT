...
function Server() {
    ...
    useEffect(() => {
        const values = {
            query: "SELECT name,des,wlink,status,image_data,cnt,Server_Storage_Backup_Solutions FROM Vendor WHERE Server_Storage_Backup_Solutions='true' AND status=1 AND cnt=5;",
            key: "Cr6re8VRBm"
        };
    ...
    const { Murisvr1, Murisvr2
    } = t('Muriserversec', { returnObjects: true });
            ...
            <div className="container">
                <div className='row '>
                    <div className="row text headingrow">
                        ...
                        <div className="col-6" data-aos="fade-up" data-aos-delay="100"><p id='topic'>{Murisvr1}</p></div>
                        <div className="col-3" data-aos="fade-up" data-aos-delay="100"><hr /></div>
                    </div>
                </div>
