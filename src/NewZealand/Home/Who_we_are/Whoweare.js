    ...
    <section id="about" className="section about">
                ...
                <div className="row iconRow">
                  ...
                  <div className='col iconCol'>
                    ...
                    <div className='row textRow'>
                      <p className='iconText'>{counterOn && <CountUp start={0} end={2024} duration={2} delay={0.5} separator="" />}<br /> Founded</p>
                    </div>
                  </div>
                  ...
                  <div className='col iconCol'>
                    ...
                    <div className='row textRow'>
                      <p className='iconText'>{counterOn && <CountUp start={0} end={100} duration={3} delay={0.5} />}+ <br />Partners</p>
                    </div>
                  </div>
      ...
      >
        ...
        <Modal.Footer className='model-footer'>
          <NavLink to="/NZ/ContactUs"><Button onClick={handleClose} className='contactUs-button'>
            Contact Us
          </Button></NavLink>
        </Modal.Footer>
      </Modal>
