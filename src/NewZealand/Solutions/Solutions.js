      ...
      <section id='hero' className='hero1 heroSolution'>
        <div className="container text-center">
          ...
          <div className="row row-cols-1 row-cols-lg-4 g-2 g-lg-3 rowmargin1234">
            <div className="col">
              <NavLink to="/NZ/Solutions/Perimia" activeClassName='active-link'>
            ...
            <div className="col">
              <NavLink to="/NZ/Solutions/CyberSecurity" activeClassName='active-link'>
                <div className="card crd">
            ...
            <div className="col">
              <NavLink to="/NZ/Solutions/Authentication" activeClassName='active-link'>
                <div className="card crd">
            ...
            <div className="col">
              <NavLink to="/NZ/Solutions/SecurityManagement" activeClassName='active-link'>
                <div className="card crd">
          ...
          <div className="row row-cols-1 row-cols-lg-4 g-2 g-lg-3 rowmargin1234">
            <div className="col">
              <NavLink to="/NZ/Solutions/EndpointSecurity" activeClassName='active-link'>
                <div className="card crd">
            ...
            <div className="col">
              <NavLink to="/NZ/Solutions/Networking" activeClassName='active-link'>
                <div className="card crd">
            ...
            <div className="col">
              <NavLink to="/NZ/Solutions/Infrastructure" activeClassName='active-link'>
                <div className="card crd">
            ...
            <div className="col">
              <NavLink to="/NZ/Solutions/Server" activeClassName='active-link'>
                <div className="card crd">
